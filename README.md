...
- [FE-interview](#fe-interview)
  - [HTML， HTTP，web综合问题](#$html，-http，web综合问题)
    ...
    - [什么是Http协议无状态协议怎么解决Http协议无状态协议](#http协议无状态协议以及解决)
...
1. [Grunt官网](https://www.gruntjs.net/getting-started)
   ...
   2. 优势：出来早 社区成熟  插件全  
   3. 缺点：配置复杂   效率低 (cpu占用率高) 

2. [Gulp官网](https://gulpjs.com/) 
   1. gulp 基于流的自动化构建工具    
   2. 优点：配置简单 效率高 流式工作（把输入的某些东西,经过某个管道处理后,输出需要的形式。）  
   3. 缺点：出现晚  插件少


3. [webpack官网](https://webpack.github.io/)
   1. webpack 模块打包机    
   2. 优点：模块化 
